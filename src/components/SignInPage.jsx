...
import {
  ...
  setDoc,
  getDoc,
  Timestamp  // ✅ FIX: Import Timestamp for Firestore dates
      ...
      if (!docSnap.exists()) {
        await setDoc(
          userDocRef,
          {
            ...
            email: user.email || "",
            createdAt: Timestamp.fromDate(new Date()),  // ✅ FIXED HERE
            customField: "",
          },
          { merge: true }
        );
        ...
        <form onSubmit={handleAuth}>
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-blue-400 hover:text-blue-200 font-bold text-sm"
            >
